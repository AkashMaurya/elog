...
{
    public partial class Add_Elog_Year : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (TextBox1.Text == "")
            {
                Label1.Text = "Please type Log Year";
            }
            else
            {
                SaveData();
        ...
        {
            con.Open();
            String query = "insert into ELogYear values ('" + TextBox1.Text + "','" + DropDownList1.Text + "')";         //Stored Procedure name   
        ...
        {
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("Select * From ELogYear", con);
