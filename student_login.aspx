<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="student_login.aspx.cs" Inherits="elog.student_login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-md-12 ">
                <div class="form-group">
                    <label for="exampleInputEmail1">Username (Your Student ID)</label>
        ...
        <div class="form-check">
            ...
            <asp:Label ID="Label1" runat="server" Text="" CssClass="form-check-label"></asp:Label>
