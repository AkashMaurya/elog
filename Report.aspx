                            ...
                            <asp:Panel ID="Panel1" runat="server" ScrollBars="Horizontal">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="20px" AllowPaging="True" CssClass="table table-bordered table-hover table-responsive" DataSourceID="SqlDataSource5">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Participante" HeaderText="Participante" SortExpression="Participante" />
                                        <asp:BoundField DataField="Activity_Type" HeaderText="Activity Type" SortExpression="Activity_Type" />
                                        <asp:BoundField DataField="Core_Diag_Sess" HeaderText="Core Diag. Sesssion" SortExpression="Core_Diag_Sess" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:Elogconnection %>" SelectCommand="SELECT DISTINCT [EYear], [Log_Year], [Department], [EGroup], [ELogGroupStudent], [Doctor_Name], [Hospital_Name], [PatientID], [Participante], [Activity_Type], [Core_Diag_Sess], [Type_Desc], [EDate], [Current_Status], [Remarks] FROM [Final_Record]"></asp:SqlDataSource>
                            </asp:Panel>
