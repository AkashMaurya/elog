                ...
                <div class="row py-3">
                    ...
                    <div class="row py-3">
                        <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" CssClass="table table-bordered table-hover table-responsive">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Status">
                                            <ItemTemplate>
                                                <asp:RadioButton ID="RadioButton1" runat="server" GroupName="select" Text="Approve" />
                                                &nbsp;&nbsp;<asp:RadioButton ID="RadioButton2" runat="server" GroupName="select" Text="Reject" />
                                                &nbsp;
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Elogconnection %>" SelectCommand="SELECT
[Id],
 [EYear]
      ,[Log_Year]
      ,[Department]
      ...
      ,[EDate]
      ,[Current_Status]
      ,[Remarks] FROM Final_Record WHERE (Current_Status = 'Approval Required')"></asp:SqlDataSource>
                            <br />
                        </div>
                    </div>
